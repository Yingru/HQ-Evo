...
std::vector<double> Langevin_post(double E, double M, double temp, double drag, double kpara, doubke kperp, double delta_lrf, std::vector<double> const& pre_result);
